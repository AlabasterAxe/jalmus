...
public class Note {
  ...
  public boolean accidentalInTonality(Tonality t, ResourceBundle bundle) {
    ...
    if (t.Alteration.equalsIgnoreCase("#")) {
      if (this.Nom == FA && t.getAlterationsNumber() >= 1) {
        return true;
      } else if (this.Nom == DO && t.getAlterationsNumber() >= 2) {
        return true;
      } else if (this.Nom == SOL && t.getAlterationsNumber() >= 3) {
        return true;
      } else if (this.Nom == RE && t.getAlterationsNumber() >= 4) {
        return true;
      } else if (this.Nom == LA && t.getAlterationsNumber() >= 5) {
        return true;
      } else if (this.Nom == MI && t.getAlterationsNumber() >= 6) {
        return true;
      } else if (this.Nom == SI && t.getAlterationsNumber() >= 7) {
        return true;
      } else {
        return false;
      }
    } else if (t.Alteration.equalsIgnoreCase("b")) {
      if (this.Nom == SI && t.getAlterationsNumber() >= 1) {
        return true;
      } else if (this.Nom == MI && t.getAlterationsNumber() >= 2) {
        return true;
      } else if (this.Nom == LA && t.getAlterationsNumber() >= 3) {
        return true;
      } else if (this.Nom == RE && t.getAlterationsNumber() >= 4) {
        return true;
      } else if (this.Nom == SOL && t.getAlterationsNumber() >= 5) {
        return true;
      } else if (this.Nom == DO && t.getAlterationsNumber() >= 6) {
        return true;
      } else if (this.Nom == FA && t.getAlterationsNumber() >= 7) {
        return true;
      } else {
        return false;
      }
