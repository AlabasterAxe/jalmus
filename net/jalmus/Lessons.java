...
enum TLevel {
  NOTELEVEL, RHYTHMLEVEL, SCORELEVEL
};
...
public class Lessons extends DefaultHandler {
  ...
  public void endElement(String uri, String localName, String qName) throws
    ...
    if (qName.equals("levels")) {
        ...
        case NOTELEVEL:
          if (tmpclef.equals("treble") | tmpclef.equals("bass") | tmpclef.equals("both")) {
            ...
            throw new SAXException("In level " + nlevel.getId()
                + " clef should be treble, bass or both");
          }
          break;
      ...
      switch (leveltype) {
        case NOTELEVEL:
          if (tmpton.equals("random")) {
            nlevel.setRandomtonality(true);
          } else {
            try {
              ...
              if ((tmpalt.equals("#") | tmpalt.equals("b")) & (tmpnbalt >= 0 & tmpnbalt <= 7)) {
                ...
                throw new SAXException("In level " + nlevel.getId()
                    + " tonality should be n# or nb with n int between 0 and 7");
              }
            } catch (Exception e) {
              //erreur, le contenu de id n'est pas un entier
      ...
      switch (leveltype) {
        case NOTELEVEL:
          if (tmpclef.equals("notes") | tmpclef.equals("accidentals") | tmpclef.equals("custom") | tmpclef.equals("intervals") | tmpclef.equals("chords")) {
            ...
            throw new SAXException("In level " + nlevel.getId() + " notes type should be notes,"
                + "accidentals, custom,  intervals or chords");
          }
          break;
        ...
        case RHYTHMLEVEL:
          ...
          if (st.countTokens() != 2)
            ...
            if (p == 2) {
              ...
              rlevel.setTimeSignNumerator(3);
            } else if (p == 4) {
              rlevel.setTimeSignNumerator(4);
            } else if (p == 6) {
              rlevel.setTimeSignNumerator(6);
            } else {
              throw new SAXException("In level " + rlevel.getId() + " numerator should be  2, 3, 4, 6  ");
            }
        ...
        case SCORELEVEL:
          ...
          if (sts.countTokens() != 2)
            ...
            if (ps == 2) {
              ...
              slevel.setTimeSignNumerator(3);
            } else if (ps == 4) {
              slevel.setTimeSignNumerator(4);
            } else if (ps == 6) {
              slevel.setTimeSignNumerator(6);
            } else {
              throw new SAXException("In level " + slevel.getId() + " numerator should be  2, 3, 4, 6  ");
            }
            ...
            if (p == 4 & ((slevel.getTimeSignNumerator() == 2) | (slevel.getTimeSignNumerator() == 3) | (slevel.getTimeSignNumerator() == 4))) {
              ...
              throw new SAXException("In level " + slevel.getId() + " denominator should be  4,8  ");
            }
          }
          break;
      }
      ...
      switch (leveltype) {
        ...
        case SCORELEVEL:
          ...
          while (sts.hasMoreTokens()) {
            ps = Integer.parseInt(sts.nextToken());
            if (ps == 1 && slevel.getTimeSignNumerator() == 4 &&
                slevel.getTimeSignDenominator() == 4) {
              slevel.setWholeNote(true);
            } else if (ps == 2) {
              slevel.setHalfNote(true);
            } else if (ps == 3 && slevel.getTimeSignNumerator() >= 3 &&
                slevel.getTimeSignDenominator() == 4) {
              slevel.setDottedHalfNote(true);
            } else if (ps == 4) {
              slevel.setQuarterNote(true);
            } else if (ps == 8) {
              slevel.setEighthNote(true);
            } else {
              throw new SAXException("In level " + slevel.getId() +
                  " rhythms should be 1, 2, 3, 4, 8  ");
            }
          }
          break;
      }
        ...
        case RHYTHMLEVEL:
          ...
          while (st.hasMoreTokens()) {
            ...
            if (p == 1) {
              ...
              throw new SAXException("In level " + rlevel.getId()
                  + " rests should be 1, 2, 3, 4, 8  ");
            }
          }
      ...
      switch (leveltype) {
        ...
        case RHYTHMLEVEL:
          ...
          while (st.hasMoreTokens()) {
            p = Integer.parseInt(st.nextToken());
            if (p == 3) {
              rlevel.setTriplet(true);
            } else {
              throw new SAXException("In level " + rlevel.getId() + " rests should be 1, 2, 4, 8  ");
            }
          }
          break;
        ...
        case SCORELEVEL:
          ...
          while (sts.hasMoreTokens()) {
            ...
            if (ps == 3) {
              ...
              throw new SAXException("In level " + slevel.getId() + " rests should be 1, 2, 4, 8  ");
            }
          }
          break;
      }
        ...
        case NOTELEVEL:
          try {
            ...
            if (temp == 3 | temp == 5 | temp == 7 | temp == 9 | temp == 15) {
              ...
              throw new SAXException("In level " + nlevel.getId() +
                  " number of notes should be 3, 5, 7, 9 or 15");
            }
          } catch (Exception e) {
            //erreur, le contenu de id n'est pas un entier
            throw new SAXException(e);
        ...
        case SCORELEVEL:
          try {
            ...
            if (temp == 9 | temp == 15) {
              ...
              throw new SAXException("In level " + nlevel.getId() +
                  " number of notes should be , 9 or 15");
            }
          } catch (Exception e) {
            //erreur, le contenu de id n'est pas un entier
            throw new SAXException(e);
     ...
     *******************************************************************/
          ...
          while (st.hasMoreTokens()) {
            ...
            if (nlevel.isCurrentKeyTreble()) {
              ...
              if (p >= 26 & p <= 96) {
                ...
                throw new SAXException("In level " + nlevel.getId() +
                    " pitches should be list pitch 26 to 96");
              }
            }
          }
      ...
      switch (leveltype) {
        case NOTELEVEL:
          ...
          if (tmpintervals.equals("second") || tmpintervals.equals("third") ||
              tmpintervals.equals("fourth") || tmpintervals.equals("fifth") ||
              tmpintervals.equals("sixth") || tmpintervals.equals("seventh") ||
              tmpintervals.equals("octave") || tmpintervals.equals("random")) {
            nlevel.setIntervaltype(tmpintervals);
          } else {
            throw new SAXException("In level " + nlevel.getId() +
                " interval type should be random or second, third ...");
          }
          break;

        case RHYTHMLEVEL:
          throw new SAXException("In level " + rlevel.getId() +
              " no number notes on rhythm level");
        ...
        case NOTELEVEL:
          try {
            ...
            if (temp >= 0 & temp <= 40) {
              ...
              throw new SAXException("In level " + nlevel.getId() +
                  " speed should be an integer between 0 and 40");
            }
          } catch (Exception e) {
            //erreur, le contenu de id n'est pas un entier
            throw new SAXException(e);
        ...
        case RHYTHMLEVEL:
          try {
            ...
            if (temp >= 0 & temp <= 200) {
              ...
              throw new SAXException("In level " + rlevel.getId() +
                  " speed should be an integer between 0 and 200");
            }
          } catch (Exception e) {
            //erreur, le contenu de id n'est pas un entier
            throw new SAXException(e);
        ...
        case NOTELEVEL:
          ...
          try {
            ...
            if (temp >= 10 & temp <= 100) {
              ...
              throw new SAXException("In level " + nlevel.getId() +
                  " learning duration should be an integer between 10 and 100");
            }
            buffer = null;
            inDuration = false;
          } catch (Exception e) {
