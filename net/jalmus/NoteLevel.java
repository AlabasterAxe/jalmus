  ...
  public void save(Lessons l, String fileName, String message, String language) 
    ...
    if (dirmylessonok) {
      ...
      if (this.isNotesgame() || this.isAccidentalsgame()) {
        ...
        fileContent.append("<startingnote>"+(5 - this.basebass)/5 +"</startingnote>"+newline);
        } else if (this.isCurrentKeyTreble()) {
        fileContent.append("<startingnote>"+(25 - this.basetreble)/5 +"</startingnote>"+newline);
        } else if (this.isCurrentKeyBoth()) {
        fileContent.append("<startingnote>"+(20 - this.basebass)/5 +"</startingnote>"+newline);
        }
      }
 ...
 */
  ...
  if (this.isCurrentKeyTreble()) {
    if ((this.nbnotesupper == 7 && this.basetreble > -20) // 15 notes
        ...
        || (this.nbnotesupper == 1 && this.basetreble > -50)){ // 3 notes
      this.basetreble = this.basetreble - 5;
    }
  } else if (this.isCurrentKeyBass()) {
