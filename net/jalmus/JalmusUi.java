	  ...
	  void init(String paramlanguage) {
        try {
		  ...
		  listenButton = new JButton();
		    ...
		    bdo = new JButton();
		    bdo.addActionListener(this.jalmus);
		    pnotes.add(bdo);
		    bre = new JButton();
		    bre.addActionListener(this.jalmus);
		    pnotes.add(bre);
		    bmi = new JButton();
		    bmi.addActionListener(this.jalmus);
		    pnotes.add(bmi);

		    bfa = new JButton();
		    bfa.addActionListener(this.jalmus);
		    pnotes.add(bfa);

		    bsol = new JButton();
		    bsol.addActionListener(this.jalmus);
		    pnotes.add(bsol);

		    bla = new JButton();
		    bla.addActionListener(this.jalmus);
		    pnotes.add(bla);

		    bsi = new JButton();
		    bsi.addActionListener(this.jalmus);
		    pnotes.add(bsi);

		    bdo2 = new JButton();
		    bdo2.addActionListener(this.jalmus);
		    pnotes.add(bdo2);

		    // BOUTONS POUR ACCORDS
		    bdiese = new JButton();
		    bdiese.setText("#");
		    bdiese.addActionListener(this.jalmus);

		    bbemol = new JButton();
		    bbemol.setText("b");
		    bbemol.addActionListener(this.jalmus);

		    bdiese2 = new JButton();
		    bdiese2.setText("#");
		    bdiese2.addActionListener(this.jalmus);

		    bbemol2 = new JButton();
		    bbemol2.setText("b");
		    bbemol2.addActionListener(this.jalmus);
